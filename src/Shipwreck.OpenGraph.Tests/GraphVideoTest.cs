...
<meta property='og:video:width' content='1' />
            ...
            Assert.Equal(new[] { 1 }, target.Videos?.Select(i => i.Width));
        }
...
<meta property='og:video:width' content='3' />
            ...
            Assert.Equal(new[] { 2 }, target.Videos?.Select(i => i.Width));
        }
...
<meta property='og:video:height' content='1' />
            ...
            Assert.Equal(new[] { 1 }, target.Videos?.Select(i => i.Height));
        }
...
<meta property='og:video:height' content='3' />
            ...
            Assert.Equal(new[] { 2 }, target.Videos?.Select(i => i.Height));
        }
